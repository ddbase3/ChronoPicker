# ChronoPicker Documentation Index
...
ChronoPicker is a standalone date/time interaction module for browser UIs.

It should support:

- visible inline date picker usage
- input-bound popover date picker usage
- date mode
- datetime mode
- strict parsing
- strict formatting
- form/filter use cases
- future range, presets, marked days and localization plugins

## Important boundary

ChronoPicker must not be implemented as a hidden part of ModularGrid.

ModularGrid can consume ChronoPicker through adapters or custom filter controls, but ChronoPicker remains an independent module.
